...
public class Model {
    ...
    private Shelter _currentShelterInfo;
    ...
    public void addUser(String username, boolean isAdmin, boolean hasClaimedBed, long numBedsClaimed) {
        User user = new User(username,isAdmin, hasClaimedBed, numBedsClaimed);
    ...
    public Shelter get_currentShelterInfo() {
        return _currentShelterInfo;
    }

    public void set_currentShelterInfo(Shelter _currentShelterInfo) {
        this._currentShelterInfo = _currentShelterInfo;
    }
